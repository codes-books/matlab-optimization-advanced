...
save data1_GA_BP test_simu output_test error
%% 寻优分析
...
save data1_GA_BP_test_result.mat test_result actual_result

%%
load('data1_GA_BP.mat')
load('data1_GA_BP_test_result.mat')
