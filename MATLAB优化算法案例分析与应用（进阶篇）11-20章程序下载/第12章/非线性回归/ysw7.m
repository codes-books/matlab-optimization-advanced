clc,clear;close all
warning off
X0 = xlsread('数据','7#','B3:B29');  % EXCEL数据
X1 = xlsread('数据','7#','E3:E29');  % EXCEL数据
X2 = xlsread('数据','7#','G3:G29');  % EXCEL数据
X3 = xlsread('数据','7#','I3:I29');  % EXCEL数据
X4 = xlsread('数据','7#','K3:K29');  % EXCEL数据
X5 = xlsread('数据','7#','M3:M29');  % EXCEL数据
X6 = xlsread('数据','7#','O3:O29');  % EXCEL数据
% initial value
a1 = 1; % 植被因子C 系数
a2 = 1; % 入流流量Q 系数
b = 1;  % 入流流量Q 指数
