clc,clear;close all
warning off
X0 = xlsread('数据','6#','B3:B19');  % EXCEL数据
X1 = xlsread('数据','6#','E3:E19');  % EXCEL数据
X2 = xlsread('数据','6#','G3:G19');  % EXCEL数据
X3 = xlsread('数据','6#','I3:I19');  % EXCEL数据
X4 = xlsread('数据','6#','K3:K19');  % EXCEL数据
X5 = xlsread('数据','6#','M3:M19');  % EXCEL数据
X6 = xlsread('数据','6#','O3:O19');  % EXCEL数据
% initial value
a1 = 1; % 植被因子C 系数
a2 = 1; % 入流流量Q 系数
b = 1;  % 入流流量Q 指数
