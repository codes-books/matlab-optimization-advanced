clc,clear;close all
warning off
X0 = xlsread('数据','3#和8#','B3:B18');  % EXCEL数据
X1 = xlsread('数据','3#和8#','E3:E18');  % EXCEL数据
X2 = xlsread('数据','3#和8#','G3:G18');  % EXCEL数据
X3 = xlsread('数据','3#和8#','I3:I18');  % EXCEL数据
X4 = xlsread('数据','3#和8#','K3:K18');  % EXCEL数据
X5 = xlsread('数据','3#和8#','M3:M18');  % EXCEL数据
X6 = xlsread('数据','3#和8#','O3:O18');  % EXCEL数据
% initial value
a1 = 1; % 植被因子C 系数
a2 = 1; % 入流流量Q 系数
b = 1;  % 入流流量Q 指数
