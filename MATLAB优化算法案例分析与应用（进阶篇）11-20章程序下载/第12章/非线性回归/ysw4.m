clc,clear;close all
warning off
X0 = xlsread('数据','4#','B3:B18');  % EXCEL数据
X1 = xlsread('数据','4#','E3:E18');  % EXCEL数据
X2 = xlsread('数据','4#','G3:G18');  % EXCEL数据
X3 = xlsread('数据','4#','I3:I18');  % EXCEL数据
X4 = xlsread('数据','4#','K3:K18');  % EXCEL数据
X5 = xlsread('数据','4#','M3:M18');  % EXCEL数据
X6 = xlsread('数据','4#','O3:O18');  % EXCEL数据
% initial value
a1 = 1; % 植被因子C 系数
a2 = 1; % 入流流量Q 系数
b = 1;  % 入流流量Q 指数
